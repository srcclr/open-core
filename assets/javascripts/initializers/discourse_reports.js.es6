...
export default {
  ...
  initialize: function(container) {
    ...
    require(PREFIX + 'models/project').default;
    ...
    require(PREFIX + 'routes/projects').default;
    require(PREFIX + 'routes/newsletters').default;
    require(PREFIX + 'routes/newsletter').default;
