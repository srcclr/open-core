  ...
  **/
  scrolled() {
    ...
    const self = this,
          ...
          //DIFF: bodyHeight = this.get('wrapperHeight') ? this.$().height() : $('body').height();
    ...
    //DIFF: if (windowBottom > bodyHeight) { windowBottom = bodyHeight; }
    //DIFF: if (viewportBottom > bodyHeight) { viewportBottom = bodyHeight; }
