...
register_asset('stylesheets/base.css.scss')
...
register_asset('stylesheets/form.css.scss')
...
register_asset('javascripts/discourse/templates/user/invited.hbs')
...
register_asset('javascripts/discourse/routes/terms-of-use.js.es6')
register_asset('javascripts/discourse/routes/privacy-policy.js.es6')
...
register_asset('javascripts/routes/communities')
