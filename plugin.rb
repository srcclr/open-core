...
register_asset('javascripts/discourse/controllers/request-community.js.es6')
...
register_asset('javascripts/discourse/views/request-community.js.es6')
...
register_asset('javascripts/discourse/templates/request-community.hbs')
